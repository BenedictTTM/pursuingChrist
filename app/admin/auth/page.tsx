      ...
      <div className="relative hidden md:flex md:w-1/2 lg:w-3/5 bg-[#111116] overflow-hidden flex-col justify-between p-12 lg:p-20">
        ...
        <div className="relative z-10 max-w-lg">
          <h1 className="font-display font-extrabold uppercase leading-none tracking-tight select-none text-5xl lg:text-7xl text-white mb-6">
            System <br />
            <span className="font-poppins italic font-normal tracking-wide text-[#C5A576]">Access</span>
          </h1>
          <p className="text-[#888A93]/90 text-[1.1rem] md:text-[1.2rem] leading-relaxed tracking-wide font-poppins italic font-light">
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                name="password"
                id="password"
                className={`w-full px-4 py-3.5 bg-white border rounded-lg focus:ring-2 focus:ring-[#C5A576]/10 focus:border-[#C5A576] outline-none transition-all duration-300 text-gray-900 placeholder-[#888A93]/50 text-sm shadow-xs ${errors.password ? 'border-red-400' : 'border-[#C5A576]/15'
                  }`}
                placeholder="••••••••"
              />
