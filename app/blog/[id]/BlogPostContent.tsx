                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                            ...
                            <div className="hidden lg:block lg:col-span-3 sticky top-32 space-y-8 text-[#4e5355]">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs font-poppins font-bold text-[#111111]" style={{ fontFamily: "var(--font-cormorant), Georgia, serif" }}>Pursuing Christ</p>
